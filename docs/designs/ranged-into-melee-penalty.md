...
3. `docs/designs/combat-rules-deviations.md`: nueva discrepancia **D-11** ("amenazándose mutuamente" vs RAW *either threatens*, `combat/06:58` y copia en `combat/10:12`) + enmienda **E-10** propuesta para el Sprint de Saneamiento documental; cierre definitivo de la fila `AOO-03` (test de regresión entregado).
