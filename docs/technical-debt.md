...
### DT-020: `tests/withdraw-server.test.mjs` importa un módulo inexistente (`validation/index.ts`) — el archivo entero nunca ejecuta — 🟡 PARCIALMENTE RESUELTO (Sprint 041.5)
