...
- Última decisión arquitectónica: Sprint D-1A-R1, Proyección Normativa de Áreas (NDD Hijo Aprobado Remediation).
- Último saneamiento documental: Sprint D-1A-R1 / Sprint D-1R1.
