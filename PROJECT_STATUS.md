...
- Última decisión arquitectónica: Sprint D-1B-Research R1 (Auditoría de Reglas de Movimiento - Remediation).
- Último saneamiento documental: Sprint D-1B-Research R1 / Sprint D-1A-R1.
