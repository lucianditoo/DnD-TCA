...
## Estado de base (Sprint 046, DEFENSE-CONCEALMENT infraestructura validada)

- Sprint 046 implementa la infraestructura independiente de `DEFENSE-CONCEALMENT`: contribuciones especializadas, assessment compartido, d100 autoritativo post-CA y bloqueo de Sneak Attack. Baseline local: `npm test` 450/450, typecheck/build verdes, WebSocket 91/91 y Playwright 6/6. La Rule ID permanece **Infraestructura solamente**; no existen fuentes productivas en este sprint.
...
3. **Condiciones, una vertical por dependencia**: Entangled Core ya dispone de tasa multiplicativa especializada y permanece Parcial hasta Concentration. Blinded puede reutilizar ahora la infraestructura de Concealment, pero necesita su propio diseño; Dazzled/Shaken después de decidir alcance de skills/checks; Exhausted debe reutilizar la proyección de velocidad; Stunned requiere caída real de objetos; Frightened/Panicked requieren movimiento obligatorio y escalado de miedo; Helpless/Coup de Grace permanece como vertical separada.
